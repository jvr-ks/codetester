...
contSenseHelp := contSenseHelpDefault
...
if (contSenseHelp){
  if (FileExist("ContextSensitiveHelp2.exe")){
    PostMessage("ContextSensitiveHelp2", 0x0001)
    sleep, 3000
    run, ContextSensitiveHelp2.exe
    showHintColoredRefresh("ContextSensitiveHelp2 started!")
  } else {
    msgbox, File not found: ContextSensitiveHelp2.exe !
  }
}
...
;---------------------------------- guiMain ----------------------------------
  ...
  menu, MainMenuMake, add, Make exe (64 bit), makeExe64
  menu, MainMenuMake, add, Make exe (32 bit), makeExe32
  ...
  menu, Mainmenu, add, Make,:MainMenuMake
...
controlAreaCreate(){
  ...
  global disableCodeModifications, contSenseHelp
  ...
  gui, controlArea:add, Text, xm w%buttonWidthSmall%, Save to:`n(_saved\)
  gui, controlArea:add, Button, x+m yp+0 vButton22 %buttonHeight% w%buttonWidthSmall% section gsaveToLast, Last used
  gui, controlArea:add, Button, x+m yp+0 vButton4 %buttonHeight% w%buttonWidthSmall% gsave, New (d._t.)
  gui, controlArea:add, Button, xs vButton30 %buttonHeight% w%buttonWidth% gsaveWithName, With a new name
    
  gui, controlArea:add, Text, xm w%buttonWidthSmall%, Other:
  gui, controlArea:add, Button, xs yp+0 vButton31 %buttonHeight% w%buttonWidthSmall%  gsaveToDir, Directory
  ...
  chkContSenseHelp := contSenseHelp ? "checked" : ""
  gui, controlArea:add, Checkbox, xm VcontSenseHelp GenableContSenseHelp %chkContSenseHelp%, Content Sensitiv Help AHK 1/2 [+F4/F4]
...
readConfig() {
  ...
  global disableCodeModifications, disableCodeModificationsDefault, contSenseHelp, contSenseHelpDefault
  ...
  contSenseHelp := iniReadSave("contSenseHelp", "config", contSenseHelpDefault)
...
saveConfig(){
  ...
  global disableCodeModifications, contSenseHelp, testSelectedCodeHotkeyDefault, testSelectedCodeHotkey
  ...
  IniWrite, %contSenseHelp%, %configFile%, config, contSenseHelp
...
;---------------------------- enableContSenseHelp ----------------------------
enableContSenseHelp(){
  global configFile, contSenseHelp, cshRun
